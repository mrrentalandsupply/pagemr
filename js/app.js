...
var data = [
  /*CAMIONES*/
  {
    ...
    model: "MARCA: CHEVROLET",
    serial: "SERIAL: 9GDP7H1C4900381 - MARCA: CHEVROLET",
  ...
  },
  {
    ...
    category: categorys[0],
    model: "MARCA: CHEVROLET",
    serial: "SERIAL: 9GDFTR32X9B000833  - MARCA: CHEVROLET",
  ...
  },
  {
    ...
    serial: "SERIAL: 8LBDTF2L3d0181488 - MARCA: LUV D-MAX 2.5L 4X2",
  ...
  },
  {
    ...
    category: categorys[0],
    model: "MARCA: LUV D-MAX 2.5L 4X2",
    serial: "SERIAL: 8LBDTF2L290017494 -  MARCA: LUV D-MAX 2.5L 4X2",
  ...
  },
  {
    ...
    serial: "SERIAL: NF80K5H-35628 - MARCA: FORD F-900",
    features: new Array("Placa: XAB 313", "Marca: FORD-F 9000", "Clase de vehículo: tracto camión", "Color azul y blanco", "Servicio público", "Número de motor 11168603 NF80K5H-35628", "Número de chasis NF80K5H-35628", "Capacidad 30 toneladas", "Número de ejes 3"),
  ...
  },
  {
    ...
    category: categorys[3],
    model: "MODELO: 2005",
    serial: "SERIAL: DAC0162068 - MARCA: CASE",
  ...
  },
  {
    ...
    category: categorys[4],
    model: "MARCA: DIECI",
    serial: "SERIAL: LH6820361 TIPO LH 682  - MARCA: DIECI",
...
function createModal(title, serial, img_src, features, n) {
  ...
  row.className += "row";
  divc.appendChild(row);

  var col_pic = document.createElement("div");
  col_pic.className += "col s12 m4";
  row.appendChild(col_pic);

  var img = document.createElement("img");
  img.src = img_src;
  img.className += "responsive-img";
  col_pic.appendChild(img);

  var col_info = document.createElement("div");
  col_info.className += "col s12 m8";
  row.appendChild(col_info);

  var h6 = document.createElement("h6");
  col_info.appendChild(h6);
  var pc = document.createTextNode("CARACTERÍSTICAS TÉCNICAS");
  h6.appendChild(pc);

  var hr = document.createElement("hr");
  col_info.appendChild(hr);

  for (var j = 0; j < features.length; j++) {
    var pf = document.createElement("p");
    col_info.appendChild(pf);
